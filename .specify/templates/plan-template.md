...
**Storage**: [if applicable, e.g., IndexedDB, localStorage, or N/A]
...
- [ ] All components follow 5-file pattern (index, Component, test, stories, a11y)
- [ ] Using `pnpm run generate:component` for new components
- [ ] No manual component creation

### II. Test-First Development
- [ ] Tests written before implementation (RED-GREEN-REFACTOR)
- [ ] Minimum 25% unit test coverage
- [ ] E2E tests for user workflows
- [ ] Accessibility tests with Pa11y

### III. PRP Methodology
- [ ] Following PRP workflow (spec → plan → tasks → implement)
- [ ] Clear success criteria defined
- [ ] Tracking from inception to completion

### IV. Docker-First Development
- [ ] Docker Compose setup included
- [ ] CI/CD uses containerized environments
...
- [ ] GDPR compliance with consent system
