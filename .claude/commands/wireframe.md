...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1400 800" width="1400" height="800">
  ...
  <g opacity="0.4">
    <pattern id="dots" width="30" height="30" patternUnits="userSpaceOnUse">
      <circle cx="15" cy="15" r="1" fill="#a5b4fc"/>
    </pattern>
  ...
  <g id="desktop-view">
    ...
    <!-- Panels use fill="#ffffff" or fill="#f3f4f6" -->
    <!-- Borders use stroke="#e5e7eb" or stroke="#d1d5db" -->
  </g>
  ...
  <g id="mobile-view" transform="translate(980, 60)">
    ...
    <rect x="0" y="0" width="360" height="700" rx="24" fill="#ffffff" stroke="#e5e7eb" stroke-width="2"/>
    <!-- Screen area: x=10, y=10, width=340, height=680, rx=16 -->
    <rect x="10" y="10" width="340" height="680" rx="16" fill="#f3f4f6"/>
    <!-- Status bar -->
    <rect x="10" y="10" width="340" height="28" rx="16" fill="#ffffff"/>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1400 800" width="1400" height="800">
  ...
  <!-- Title -->
  <text x="700" y="28" text-anchor="middle" font-family="system-ui, sans-serif" font-size="14" font-weight="600" fill="#64748b" letter-spacing="1">ARCHITECTURE DIAGRAM TITLE</text>
...
<g class="annotation-box">
  <rect x="20" y="130" width="100" height="45" rx="4" fill="#ffffff" stroke="#8b5cf6" stroke-width="1"/>
