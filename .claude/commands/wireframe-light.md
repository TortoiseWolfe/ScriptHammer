...
```bash
grep -r "GENERATED BY: /wireframe-light skill" docs/design/wireframes/
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1400 800" width="1400" height="800">
  <!-- ============================================================
       GENERATED BY: /wireframe-light skill
...
<!-- Annotation box at left margin - use parchment fill -->
<g class="annotation-box">
  <rect x="20" y="200" width="100" height="36" rx="4" fill="#e8d4b8" stroke="#8b5cf6" stroke-width="1"/>
...
<g transform="translate(CENTER_X, CENTER_Y)">
  <!-- Track circle (background) - use darker parchment -->
  <circle cx="0" cy="0" r="12" fill="none" stroke="#dcc8a8" stroke-width="2"/>
  <!-- Spinning arc -->
