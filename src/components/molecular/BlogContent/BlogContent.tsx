...
export default function BlogContent({ htmlContent }: BlogContentProps) {
  ...
  return (
    <div
      ref={contentRef}
      className="[&>.mockup-code]:not-prose [&_code]:bg-base-200 [&_a]:link [&_a]:link-primary [&_a]:hover:link-hover [&_em]:text-base-content/70 [&_code]:rounded [&_code]:px-1 [&_code]:py-0.5 [&_code]:text-[10px] sm:[&_code]:text-xs md:[&_code]:text-sm [&_em]:text-[10px] [&_em]:italic sm:[&_em]:text-xs md:[&_em]:text-sm lg:[&_em]:text-base [&_img]:my-3 [&_img]:h-auto [&_img]:max-w-full [&_img]:rounded-lg [&_img]:shadow-lg sm:[&_img]:my-4 md:[&_img]:my-6 lg:[&_img]:my-8 [&_li]:text-xs [&_li]:leading-relaxed sm:[&_li]:text-sm md:[&_li]:text-base lg:[&_li]:text-lg [&>h1]:mt-4 [&>h1]:mb-2 [&>h1]:text-lg [&>h1]:font-bold sm:[&>h1]:mt-6 sm:[&>h1]:mb-3 sm:[&>h1]:text-xl md:[&>h1]:mt-8 md:[&>h1]:mb-4 md:[&>h1]:text-2xl lg:[&>h1]:mt-12 lg:[&>h1]:mb-6 lg:[&>h1]:text-3xl [&>h2]:mt-3 [&>h2]:mb-1.5 [&>h2]:text-base [&>h2]:font-bold sm:[&>h2]:mt-4 sm:[&>h2]:mb-2 sm:[&>h2]:text-lg md:[&>h2]:mt-6 md:[&>h2]:mb-3 md:[&>h2]:text-xl lg:[&>h2]:mt-8 lg:[&>h2]:mb-4 lg:[&>h2]:text-2xl [&>h3]:mt-2 [&>h3]:mb-1 [&>h3]:text-sm [&>h3]:font-bold sm:[&>h3]:mt-3 sm:[&>h3]:mb-2 sm:[&>h3]:text-base md:[&>h3]:mt-4 md:[&>h3]:mb-3 md:[&>h3]:text-lg lg:[&>h3]:mt-6 lg:[&>h3]:mb-4 lg:[&>h3]:text-xl [&>h4]:mt-1.5 [&>h4]:mb-0.5 [&>h4]:text-xs [&>h4]:font-bold sm:[&>h4]:mt-2 sm:[&>h4]:mb-1 sm:[&>h4]:text-sm md:[&>h4]:mt-3 md:[&>h4]:mb-2 md:[&>h4]:text-base lg:[&>h4]:mt-4 lg:[&>h4]:mb-3 lg:[&>h4]:text-lg [&>ol]:my-2 [&>ol]:ml-4 [&>ol]:list-decimal [&>ol]:space-y-0.5 sm:[&>ol]:my-3 sm:[&>ol]:ml-5 sm:[&>ol]:space-y-1 md:[&>ol]:my-4 md:[&>ol]:ml-6 md:[&>ol]:space-y-2 lg:[&>ol]:my-6 lg:[&>ol]:ml-8 lg:[&>ol]:space-y-3 [&>p]:mb-2 [&>p]:text-xs [&>p]:leading-relaxed sm:[&>p]:mb-3 sm:[&>p]:text-sm md:[&>p]:mb-4 md:[&>p]:text-base lg:[&>p]:mb-6 lg:[&>p]:text-lg [&>ul]:my-2 [&>ul]:ml-4 [&>ul]:list-disc [&>ul]:space-y-0.5 sm:[&>ul]:my-3 sm:[&>ul]:ml-5 sm:[&>ul]:space-y-1 md:[&>ul]:my-4 md:[&>ul]:ml-6 md:[&>ul]:space-y-2 lg:[&>ul]:my-6 lg:[&>ul]:ml-8 lg:[&>ul]:space-y-3"
