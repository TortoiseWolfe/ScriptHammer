...
Claude reads this output and decides what to do—but the *detection* happened in Python.
...
The Validator checks individual files. But what about consistency *across* files?
...
The Inspector runs *after* Validator passes and checks patterns across all SVGs:
...
*This is Part 1 of a three-part series on scaling AI-assisted development. Part 2 covers our multi-terminal coordination system. Part 3 tells the story of how we got here.*
