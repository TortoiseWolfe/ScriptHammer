...
- `scripts/rebrand.sh` — a 600+ line script that rebrands 932 files in 71 seconds (measured 2026-08-27) (name, owner, theme, docker service, env example), with `--dry-run`, CI-friendly exit codes, and already-rebranded detection.
