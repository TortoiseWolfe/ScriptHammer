...
Two targeted UX improvements for the messaging system: (1) Fix character count display to show "0 / 10000" instead of "/ 10000" when the input is empty, and (2) Add simple markdown rendering to message bubbles so text formatting like **bold**, *italic*, and `code` renders properly instead of showing raw syntax.
